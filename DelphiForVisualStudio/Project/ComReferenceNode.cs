...
namespace Microsoft.VisualStudio.Package
{
    ...
    [CLSCompliant(false)]
    [ComVisible(true)]
    public class ComReferenceNode : TEntryPointFileNode
	{
		#region fields
		...
		public int MajorVersionNumber
		{
			get
			{
				...
				return int.Parse(majorVersionNumber);
			}
		}
		public int MinorVersionNumber
		{
			get
			{
				...
				return int.Parse(minorVersionNumber);
			}
		}
        ...
        /// </summary>
        public ComReferenceNode(ProjectNode root, ProjectElement e):base(root,e)
        {
		...
		public ComReferenceNode(ProjectNode root, VSCOMPONENTSELECTORDATA selectorData):base(root)
		{
			if (root == null)
