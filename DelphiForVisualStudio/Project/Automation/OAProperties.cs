...
{
    /// <summary>
    /// This class defines automation support for properties.
    /// </summary>
    ...
    public class OAProperties : EnvDTE.Properties
    {
        ...
        public virtual EnvDTE.Property Item(object index)
        {
            ...
            // BaseCodeChange: The line below caused an exception when a folder
            // node existed in the project as a request for BuildAction proptery
            // on the node was not valid.  The line blow the comment is the new
            // code .
