...
namespace Microsoft.VisualStudio.Package
{
	...
	public class SolutionListenerForProjectReferenceUpdate : SolutionListener
	{
		...
		#region ctor
		public SolutionListenerForProjectReferenceUpdate(IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		#endregion
		...
		private ProjectReferenceNode GetProjectReferenceOnNodeForHierarchy(IList<TEntryPointFileNode> references, IVsHierarchy inputHierarchy)
		{
			if (references == null)
			{
				return null;
			...
			foreach (TEntryPointFileNode refNode in references)
			{
